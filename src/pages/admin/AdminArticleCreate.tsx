...
import { createArticle, type ArticlePayload } from '../../api/articles';
...
export default function AdminArticleCreate() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await createArticle(payload, imageFile || undefined);
  ...
  return (
    <AdminLayout title="Tambahkan Artikel">
      <div className="bg-white rounded-[18px] px-7 py-6 shadow-[0_8px_24px_rgba(15,23,42,0.12)] border border-[#f0f0f0] max-w-[1200px] w-full mx-auto">
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Tambahkan Artikel</h1>
        </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-[100] grid place-items-center p-4">
          <div className="bg-white rounded-2xl p-6 max-w-[380px] w-full shadow-[0_20px_50px_rgba(0,0,0,0.3)]">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600">Artikel berhasil dibuat</p>
            </div>
