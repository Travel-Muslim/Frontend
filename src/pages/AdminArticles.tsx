...
function IconEye() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <path d="M3 12s3.5-6 9-6 9 6 9 6-3.5 6-9 6-9-6-9-6Z" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
...
function IconPencil() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <path d="M15.5 5.5 18.5 8.5 9 18H6v-3L15.5 5.5Z" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M13.5 7.5 16.5 10.5" fill="none" stroke="currentColor" strokeWidth="2" />
    </svg>
  );
}
...
function IconTrash() {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      <path d="M6 7h12" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M9 7v12m6-12v12" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M10 4h4a1 1 0 0 1 1 1v2H9V5a1 1 0 0 1 1-1Z" fill="none" stroke="currentColor" strokeWidth="2" />
      <path d="M5 7h14v12.5a1.5 1.5 0 0 1-1.5 1.5h-11A1.5 1.5 0 0 1 5 19.5V7Z" fill="none" stroke="currentColor" strokeWidth="2" />
    </svg>
  );
}
          ...
          <div className="ap-card-head aa-card-head">
            ...
            <div className="ap-actions">
              <div className="ap-search">
                <svg viewBox="0 0 24 24" aria-hidden="true">
                  <circle cx="11" cy="11" r="6" stroke="#a6a6a6" strokeWidth="2" fill="none" />
                  <path d="m15 15 4.5 4.5" stroke="#a6a6a6" strokeWidth="2" strokeLinecap="round" />
                </svg>
                <input type="text" placeholder="Cari Artikel" value={query} onChange={(e) => setQuery(e.target.value)} />
              </div>
              <button type="button" className="ap-add-btn" onClick={() => navigate("/admin/articles/new")}>
                <IconPlus />
                Tambahkan Artikel
              </button>
            </div>
              ...
              {loading ? (
                ...
                filtered.map((article) => (
                  <div className="ap-row aa-row" key={article.id}>
                    ...
                    <span className="ap-actions-row aa-actions" data-label="Aksi">
                      <button type="button" className="ap-btn ap-btn-view" aria-label="Lihat artikel" onClick={() => navigate(`/admin/articles/${article.id}`)}>
                        <IconEye />
                      </button>
                      <button type="button" className="ap-btn ap-btn-edit" aria-label="Edit artikel" onClick={() => navigate(`/admin/articles/${article.id}`)}>
                        <IconPencil />
                      </button>
                      <button type="button" className="ap-btn ap-btn-delete" aria-label="Hapus artikel" onClick={() => handleDelete(article.id)}>
                        <IconTrash />
                      </button>
                    </span>
                  </div>
          ...
          <div className="ap-modal">
            <div className="ap-modal-card">
              ...
              <div className="ap-modal-actions">
                <button type="button" className="ap-modal-btn cancel" onClick={() => setConfirmId(null)}>
                  Batal
                </button>
                <button type="button" className="ap-modal-btn confirm" onClick={confirmDelete}>
                  Hapus
                </button>
              </div>
            </div>
        ...
        {deleteSuccess && (
          <div className="ap-modal">
            <div className="ap-modal-card">
              ...
              <div className="ap-modal-actions">
                <button type="button" className="ap-modal-btn confirm" onClick={() => setDeleteSuccess(false)}>
                  Selanjutnya
                </button>
              </div>
            </div>
